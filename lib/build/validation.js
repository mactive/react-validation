	    ...
	    var CustomInput = function (_Base) {
	        ...
	        _createClass(CustomInput, [{
	            ...
	            value: function render() {
	                ...
	                if (isInvalid) {
	                	hint = typeof error === 'function' ? error(this.state.value, this.props.label, this.props.name,this.context.components) : _rules2.default[error].hint(this.state.value, this.props.label, this.props.name, this.context.components);
	                }
